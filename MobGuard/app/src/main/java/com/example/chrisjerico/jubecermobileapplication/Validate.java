...
/**
 * Created by Chris Jerico Albino on 9/13/2017.
 */

public class Validate extends AsyncTask <String,Void,String> {
    MainProfileSgBackgroundWorker context;
    AlertDialog alertdialog;

    Validate(MainProfileSgBackgroundWorker ctx) {
        context = ctx;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        String login_url = "http://192.168.22.6/secup.php";
