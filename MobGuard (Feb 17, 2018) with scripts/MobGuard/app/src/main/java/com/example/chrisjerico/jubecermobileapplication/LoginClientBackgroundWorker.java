...
public class LoginClientBackgroundWorker  extends AsyncTask<String,Void,String> {
    Context context;
    AlertDialog alertdialog;

    LoginClientBackgroundWorker(Context ctx) {
        context = ctx;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        String login_url = "http://192.168.43.166/loginclient.php";
        ...
        if (type.equals("login")) {
            try {
                String clientuser = params[1];
                String clientpass  = params[2];
                ...
                String post_data = URLEncoder.encode("clientuser", "UTF-8") + "=" + URLEncoder.encode(clientuser, "UTF-8"); //+ "&" + URLEncoder.encode("clientpass", "UTF-8") + "=" + URLEncoder.encode(clientpass, "UTF-8");
